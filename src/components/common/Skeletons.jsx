        ...
        <div className="bg-slate-900 border border-slate-800 p-6 rounded-xl relative overflow-hidden">
            <div className="animate-pulse flex flex-col gap-4">
                ...
                <div className="flex justify-between items-start">
                    ...
                    <div className="w-16 h-16 rounded-full bg-slate-800 opacity-20 absolute top-0 right-0 translate-x-1/3 -translate-y-1/3" />
                </div>

                {/* Value & Label */}
                <div className="space-y-2 mt-2">
                    <div className="h-8 w-16 bg-slate-800 rounded-md" /> {/* Value */}
                    <div className="h-4 w-24 bg-slate-800 rounded-md" /> {/* Label */}
                </div>
            </div>
        </div>
    );
    ...
    return (
        <div className="space-y-4 animate-pulse">
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-2xl overflow-hidden">
                {/* Header */}
                <div className="h-12 bg-slate-800/50 border-b border-slate-800 w-full mb-2" />
